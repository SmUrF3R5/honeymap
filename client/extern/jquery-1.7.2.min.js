...
(function(e) {
 ...
 e.fn.vectorMap = function(e) {
  ...
  if (e === "addMap") jvm.WorldMap.maps[arguments[1]] = arguments[2];
   ...
   if (!(e !== "set" && e !== "get" || !t[e][arguments[1]])) return r = arguments[1].charAt(0).toUpperCase() + arguments[1].substr(1), this.data("mapObject")[e + r].apply(this.data("mapObject"), Array.prototype.slice.call(arguments, 2));
   e = e || {}, e.container = this, n = new jvm.WorldMap(e), this.data("mapObject", n)
  }
 }
})(jQuery),
function(e) {
...
jvm.AbstractElement = function(e, t) {
 this.node = this.createElement(e), this.name = e, this.properties = {}, this.set(t)
 ...
 this.isSelected !== e && (this.isSelected = e, this.updateStyle(), $(this.node).trigger("selected", [e]))
}, jvm.AbstractShapeElement.prototype.setStyle = function(e, t) {
 var n = {};
 typeof e == "object" ? n = e : n[e] = t, $.extend(this.style.current, n), this.updateStyle()
}, jvm.AbstractShapeElement.prototype.updateStyle = function() {
 var e = {};
 $.extend(e, this.style.initial || {}), $.extend(e, this.style.current || {}), this.isHovered && $.extend(e, this.style.hover || {}), this.isSelected && ($.extend(e, this.style.selected || {}), this.isHovered && $.extend(e, this.style.selectedHover || {})), this.set(e)
 ...
 var n;
 e = e || {}, e.attribute = e.attribute || "fill", e.scale = e.scale || ["#FFBF00", "#ff0000"], n = e.attribute === "fill" || e.attribute === "stroke" ? jvm.ColorScale : jvm.NumericScale, this.elements = t, this.params = e, e.attributes && this.setAttributes(e.attributes), this.scale = new n(e.scale, e.normalizeFunction, e.min, e.max), e.values && (this.values = e.values, this.setValues(e.values))
}, jvm.DataSeries.prototype = {
 setAttributes: function(e, t) {
  var n = e,
   r;
  if (typeof e == "string") this.elements[e].setStyle(this.params.attribute, t);
  else
 ...
 setValues: function(e) {
  ...
  for (i in e) r = parseFloat(e[i]), r ? s[i] = this.scale.getValue(r) : s[i] = this.elements[i].element.style.initial[this.params.attribute];
 ...
 var t = this,
  n;
 this.params = $.extend(!0, {}, jvm.WorldMap.defaultParams, e), this.mapData = jvm.WorldMap.maps[this.params.map], this.markers = {}, this.regions = {}, this.regionsColors = {}, this.regionsData = {}, this.container = this.params.container, this.container.css({
  position: "relative",
  overflow: "hidden"
 }), this.defaultWidth = this.mapData.width, this.defaultHeight = this.mapData.height, this.setBackgroundColor(this.params.backgroundColor), $(window).resize(function() {
  t.setSize()
 });
 for (n in jvm.WorldMap.apiEvents) this.params[n] && this.container.bind(jvm.WorldMap.apiEvents[n] + ".jvectormap", this.params[n]);
 this.canvas = new jvm.VectorCanvas(this.params.container[0], this.width, this.height), "ontouchstart" in window || window.DocumentTouch && document instanceof DocumentTouch ? this.bindContainerTouchEvents() : this.bindContainerEvents(), this.bindElementEvents(), this.createLabel(), this.bindZoomButtons(), this.createRegions(), this.createMarkers(this.params.markers || {}), this.setSize(), this.params.focusOn && (typeof this.params.focusOn == "object" ? this.setFocus.call(this, this.params.focusOn.scale, this.params.focusOn.x, this.params.focusOn.y) : this.setFocus.call(this, this.params.focusOn)), this.params.series && this.createSeries()
 ...
 reset: function() {
  ...
  for (e in this.regions) this.regions[e].element.setStyle("fill", jvm.WorldMap.defaultColor);
 ...
 bindContainerTouchEvents: function() {
  var e, t, n, r = this,
   i, s, o, u;
  $(this.container).bind("gesturestart", function(i) {
   return e = r.scale, t = r.transX, n = r.transY, !1
  }), $(this.container).bind("gesturechange", function(t) {
 ...
 bindElementEvents: function() {
  ...
  this.container.mousemove(function() {
   t = !0
  }), this.container.delegate(".jvectormap-region, .jvectormap-marker", "mouseover mouseout", function(t) {
   var n = this,
    r = $(this).attr("class").indexOf("jvectormap-region") === -1 ? "marker" : "region",
    i = r == "region" ? $(this).attr("data-code") : $(this).attr("data-index"),
    s = r == "region" ? e.regions[i].element : e.markers[i].element,
    o = r == "region" ? e.mapData.paths[i].name : e.markers[i].config.name || "",
    u = $.Event(r + "LabelShow.jvectormap"),
    a = $.Event(r + "Over.jvectormap");
   ...
   t = !1
  }), this.container.delegate(".jvectormap-region, .jvectormap-marker", "mouseup", function(n) {
   var r = this,
    i = $(this).attr("class").indexOf("jvectormap-region") === -1 ? "marker" : "region",
    s = i == "region" ? $(this).attr("data-code") : $(this).attr("data-index"),
    o = $.Event(i + "Click.jvectormap"),
    u = i == "region" ? e.regions[s].element : e.markers[s].element;
   if (!t) {
    e.container.trigger(o, [s]);
    if (i === "region" && e.params.regionsSelectable || i === "marker" && e.params.markersSelectable) o.isDefaultPrevented() || u.setSelected(!u.isSelected)
   }
  })
 },
 bindZoomButtons: function() {
  var e = this;
  $("<div/>").addClass("jvectormap-zoomin").text("+").appendTo(this.container), $("<div/>").addClass("jvectormap-zoomout").html("&#x2212;").appendTo(this.container), this.container.find(".jvectormap-zoomin").click(function() {
 ...
 createLabel: function() {
  var e = this;
  this.label = $("<div/>").addClass("jvectormap-label").appendTo($("body")), this.container.mousemove(function(t) {
   e.label.is(":visible") && e.label.css({
    left: t.pageX - 15 - e.labelWidth,
    top: t.pageY - 15 - e.labelHeight
   })
  })
 },
 setScale: function(e, t, n, r) {
  var i;
  e > this.params.zoomMax * this.baseScale ? e = this.params.zoomMax * this.baseScale : e < this.params.zoomMin * this.baseScale && (e = this.params.zoomMin * this.baseScale), typeof t != "undefined" && typeof n != "undefined" && (i = e / this.scale, r ? (this.transX = t + this.defaultWidth * (this.width / (this.defaultWidth * e)) / 2, this.transY = n + this.defaultHeight * (this.height / (this.defaultHeight * e)) / 2) : (this.transX -= (i - 1) / e * t, this.transY -= (i - 1) / e * n)), this.scale = e, this.applyTransform()
 },
 ...
 getSelectedRegions: function() {
  var e, t = [];
  for (e in this.regions) this.regions[e].element.isSelected && t.push(e);
  return t
 },
 getSelectedMarkers: function() {
  var e, t = [];
  for (e in this.markers) this.markers[e].element.isSelected && t.push(e);
  return t
 },
 ...
 createRegions: function() {
  ...
  for (e in this.mapData.paths) t = this.canvas.addPath({
   ...
   "data-code": e
  }, $.extend({}, this.params.regionStyle)), $(t.node).bind("selected", function(e, t) {
   n.container.trigger("regionSelected.jvectormap", [$(this).attr("data-code"), t, n.getSelectedRegions()])
  }), t.addClass("jvectormap-region"), this.regions[e] = {
   element: t,
   config: this.mapData.paths[e]
  }
 },
 createMarkers: function(e) {
  var t = this.canvas.addGroup(),
   n, r, i, s, o, u = this;
  if ($.isArray(e)) {
   o = e.slice(), e = {};
   for (n = 0; n < o.length; n++) e[n] = o[n]
  }
  for (n in e) s = e[n] instanceof Array ? {
   latLng: e[n]
  } : e[n], i = this.latLngToPoint.apply(this, s.latLng || [0, 0]), r = this.canvas.addCircle({
   "data-index": n,
   cx: i.x,
   cy: i.y
  }, $.extend(!0, {}, this.params.markerStyle, {
   initial: s.style || {}
  }), t), r.addClass("jvectormap-marker"), $(r.node).bind("selected", function(e, t) {
   u.container.trigger("markerSelected.jvectormap", [$(this).attr("data-index"), t, u.getSelectedMarkers()])
  }), this.markers[n] && this.removeMarkers([n]), this.markers[n] = {
   element: r,
   config: s
  }
 },
...
}, jvm.WorldMap.maps = {}, jvm.WorldMap.circumference = 40075017, jvm.WorldMap.defaultParams = {
 map: "world_mill_en",
